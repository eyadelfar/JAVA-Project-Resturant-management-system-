...
public class UI extends JFrame implements ActionListener
{
    ...
    *****************************************************************/
    private class EmployeeListPanel extends JPanel implements ActionListener
    {
        ...
        public EmployeeListPanel()
        {
            ...
            btnSearchStaff    = new JButton("Search staff");
            btnSearchStaff.addActionListener(this);
            gbc.gridx = 1;
            gbc.gridy = 1;
            gbLayout.setConstraints(btnSearchStaff, gbc);
            this.add(btnSearchStaff);
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            else if (ae.getSource() == btnSearchStaff)
            {
                cEditEmployeePanel.init(0);
                changeMainPanel("EditEmployee");
            }
    ...
    *****************************************************************/
        ...
        public void actionPerformed(ActionEvent ae) {
            if (ae.getSource() == btnOK)
            {
                ...
                else
                {
                    ...
                    if(!rcController.addNewStaff(staffID,new String(tbPassword.getPassword()),tbFirstName.getText(),tbLastName.getText(),isManager))
                    {
                        showErrorDialog("Error", rcController.getErrorMessage());
                        return;
                    }
    ...
    private class EditEmployeePanel2 extends JPanel implements ActionListener
    {
        private JLabel          lblStaffID;
        private JTextField      tbStaffID;
        private JButton         btnOK;
